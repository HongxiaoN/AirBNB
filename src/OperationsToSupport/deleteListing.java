...
public class deleteListing {
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet checklid = statement.executeQuery("SELECT * FROM lists WHERE lid='" + lid + " AND exist=1'");
            if (!checklid.next()) {
            ...
            int updateList = statement.executeUpdate("UPDATE lists SET exist = 0 WHERE lid='" + lid + "'");
            if (updateList == 1) {
